...
```bash
python3 scripts/native_enhance_pptx.py plan "<project>"
```
...
```bash
python3 scripts/native_enhance_pptx.py validate "<project>"
```
...
```bash
python3 scripts/notes_to_audio.py "<project>" \
...
```bash
python3 scripts/native_enhance_pptx.py apply "<project>"
```

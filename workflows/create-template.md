...
ls -la "templates/<kind_dir>/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 scripts/svg_quality_checker.py "templates/<kind_dir>/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
# For deck (default)
python3 scripts/register_template.py <template_id> --kind deck

# For layout
python3 scripts/register_template.py <template_id> --kind layout
```
...
>
> ```bash
> python3 scripts/register_template.py --kind deck --rebuild-all
> python3 scripts/register_template.py --kind layout --rebuild-all
> ```

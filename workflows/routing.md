...
| Final PPTX local review | User explicitly asks for `officecli-local-review`, local visual review of the exported PPTX, or a post-export second opinion | [`officecli-local-review`](./officecli-local-review.md) after Phase 6 | Exported PPTX exists and passed Fusion structural/editability checks | Advisory sidecar plus local PDF/PNG evidence | Local tools only; no remote route exists |

...
当 deck 选择 `templates/html/guizang/template-swiss.html` / `references/guizang-layouts-swiss.md` 时,优先使用下面这组提示词。目标是生成能直接放进登记版式图片槽位的素材,尤其是 S22 顶部横幅、S15/S16 多图网格。

...
## visual_tone
- tone: professional, restrained, data-forward
- quality_bar: one detail at 120%, rest at 80%; avoid uniform用力
- anti_slop: no purple gradients, no emoji icons, no rounded cards with left accent border, no SVG-drawn people

> **From huashu-design**: design quality bar and anti-AI-slop enforcement.
> - `tone` — one-line descriptor (e.g., "editorial", "tech minimal", "neo-Chinese")
> - `quality_bar` — the "one detail at 120%" principle; pick ONE element to excel, keep others at 80%
> - `anti_slop` — checklist of forbidden AI-default patterns. Add/remove per deck.

## narrative_shape
- shape: problem-to-solution
- thesis: [One-sentence core message]
- evidence_gaps: [List of unverified claims or missing data]

> **From dashiai-ppt-structure**: audience-first narrative framework.
> - `shape` — one of: problem-to-solution, strategic-recommendation, investment-case, operating-review, proposal, launch-story, teaching-narrative
> - `thesis` — one clear sentence (not a topic list); the decision the deck must support
> - `evidence_gaps` — verified facts vs. assumptions vs. missing evidence
